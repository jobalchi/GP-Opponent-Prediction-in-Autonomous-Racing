...
from active_racepkg.dynamics.models.dynamics_models import CasadiDynamicsModel
from active_racepkg.common.pytypes import VehicleState, VehicleActuation, VehiclePrediction
from active_racepkg.dynamics.models.obstacle_types import RectangleObstacle

from active_racepkg.controllers.abstract_controller import AbstractController
from active_racepkg.controllers.utils.controllerTypes import MPCCApproxFullModelParams
...
class MPCC_H2H_approx(AbstractController):
    ...
    def __init__(self, dynamics, track, control_params=MPCCApproxFullModelParams(), name=None, track_name=None):
        ...
        self.lencar = 0.65#0.36  # TODO: change
        self.widthcar = 0.3#0.2  # Ratio of car length to width
